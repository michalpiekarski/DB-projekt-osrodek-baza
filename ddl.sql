...
CREATE TABLE DOMKI
  ( id INTEGER NOT NULL , numer INTEGER
  ) ;
...
ALTER TABLE DOMKI ADD CONSTRAINT IDDomku FOREIGN KEY ( id ) REFERENCES OBIEKTY ( id ) ;

ALTER TABLE INNE_OBIEKTY ADD CONSTRAINT IDInnegoObiektu FOREIGN KEY ( id ) REFERENCES OBIEKTY ( id ) ;

ALTER TABLE POKOJE ADD CONSTRAINT IDPokoju FOREIGN KEY ( id ) REFERENCES OBIEKTY ( id ) ;

ALTER TABLE ZAMOWIENIA_POSILKOW ADD CONSTRAINT IDZamowieniaPosilku FOREIGN KEY ( id ) REFERENCES ZAMOWIENIA ( id ) ;

ALTER TABLE ZAMOWIENIA_USLUG ADD CONSTRAINT IDZamowieniaUslugi FOREIGN KEY ( id ) REFERENCES ZAMOWIENIA ( id ) ;

ALTER TABLE ZAMOWIENIA_WYPOZYCZEN ADD CONSTRAINT IDZamowieniaWypozyczenia FOREIGN KEY ( id ) REFERENCES ZAMOWIENIA ( id ) ;
...
ALTER TABLE ZAMOWIENIA ADD CONSTRAINT RachunekZamowienia FOREIGN KEY ( rachunek ) REFERENCES RACHUNKI ( id ) ON
DELETE CASCADE ;
...
ALTER TABLE ZAMOWIENIA_POSILKOW ADD CONSTRAINT TypZamowieniaPosilku FOREIGN KEY ( typ ) REFERENCES POSILKI ( nazwa ) ;

ALTER TABLE ZAMOWIENIA_USLUG ADD CONSTRAINT TypZamowieniaUslugi FOREIGN KEY ( typ ) REFERENCES USLUGI ( nazwa ) ;

ALTER TABLE ZAMOWIENIA_WYPOZYCZEN ADD CONSTRAINT TypZamowieniaWypozyczenia FOREIGN KEY ( typ ) REFERENCES WYPOZYCZENIA ( nazwa ) ;
...
CREATE OR REPLACE TRIGGER FKNTM_ZAMOWIENIA BEFORE
  UPDATE OF rachunek ON ZAMOWIENIA BEGIN raise_application_error(-20225,'Non Transferable FK constraint  on table ZAMOWIENIA is violated');
END;
/

--  ERROR: No Discriminator Column found in Arc FKArc_30 - constraint trigger for Arc cannot be generated
--  ERROR: No Discriminator Column found in Arc FKArc_30 - constraint trigger for Arc cannot be generated
--  ERROR: No Discriminator Column found in Arc FKArc_30 - constraint trigger for Arc cannot be generated

--  ERROR: No Discriminator Column found in Arc FKArc_31 - constraint trigger for Arc cannot be generated
--  ERROR: No Discriminator Column found in Arc FKArc_31 - constraint trigger for Arc cannot be generated
--  ERROR: No Discriminator Column found in Arc FKArc_31 - constraint trigger for Arc cannot be generated
